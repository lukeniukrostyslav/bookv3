...
uid="urn:uuid:7d9d8f8e-4f1d-4e3d-9b0a-5e7c2a9d1f32"
...
<html xmlns="http://www.w3.org/1999/xhtml" lang="ru" xml:lang="ru"><head><title>{html.escape(title)}</title><link rel="stylesheet" type="text/css" href="style.css"/></head><body><h1>{html.escape(title)}</h1>{body}</body></html>'''
...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:epub="http://www.idpf.org/2007/ops" lang="ru" xml:lang="ru"><head><title>Содержание</title></head><body><nav epub:type="toc"><h1>Содержание</h1><ol>{nav_items}</ol></nav></body></html>'''
...
<manifest>{''.join(manifest)}</manifest><spine page-progression-direction="ltr">{''.join(spine)}</spine></package>'''
